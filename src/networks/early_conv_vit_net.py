...
def get_post_attention_list():
    global POST_ATTENTION_LIST
    post_attention_list = POST_ATTENTION_LIST
    POST_ATTENTION_LIST = []
    return post_attention_list
...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        if POST_REC:
            POST_ATTENTION_LIST.append(out)
